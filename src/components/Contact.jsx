      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-4">
            ...
            <a href={cv.contact.linkedin}>
              <i className="fab fa-linkedin text-white text-xl hover:text-purple-400"></i>
            </a>
          </div>
        </div>
          ...
          >
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                id="submit-button"
                className="bg-[#7f5af0] cursor-pointer text-white px-6 py-2 rounded-lg hover:shadow-[0_0_15px_4px_rgba(192,132,252,0.6)] transition text-sm"
              >
