...
export function Experiences(){
    ...
    <div className="mb-10 ml-6">
      ...
      <h3 className="text-lg font-semibold text-white">{cv.experiences[0].role}</h3>
      <span className="block mb-2 text-sm font-medium text-gray-400">{cv.experiences[0].period}</span>
